const services = [
  {
    ...
    icon: (
      ...
      >
        <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm6 15h-4.5v4.5h-3V15H6l6-6 6 6z" />
      </svg>
    ),
    description:
      "Deploy, manage, and optimize cloud infrastructure using AWS services like EC2, Lambda, API Gateway, and S3.",
  },
  {
